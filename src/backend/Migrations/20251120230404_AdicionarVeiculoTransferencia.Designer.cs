...
namespace Parking.Api.Migrations
{
    ...
    [Migration("20251120230404_AdicionarVeiculoTransferencia")]
    partial class AdicionarVeiculoTransferencia
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Parking.Api.Models.VeiculoTransferencia", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.Property<Guid>("ClienteAnteriorId")
                        .HasColumnType("uuid")
                        .HasColumnName("cliente_anterior_id");

                    b.Property<Guid>("ClienteNovoId")
                        .HasColumnType("uuid")
                        .HasColumnName("cliente_novo_id");
                    ...
                    b.HasIndex("ClienteAnteriorId");

                    b.HasIndex("ClienteNovoId");

                    b.HasIndex("DataTransferencia");

                    b.HasIndex("VeiculoId");

                    b.HasIndex("VeiculoId", "DataTransferencia");

                    b.ToTable("veiculo_transferencia", "public");
                });
            ...
            modelBuilder.Entity("Parking.Api.Models.VeiculoTransferencia", b =>
                {
                    b.HasOne("Parking.Api.Models.Cliente", "ClienteAnterior")
                        .WithMany()
                        .HasForeignKey("ClienteAnteriorId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("Parking.Api.Models.Cliente", "ClienteNovo")
                        .WithMany()
                        .HasForeignKey("ClienteNovoId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
